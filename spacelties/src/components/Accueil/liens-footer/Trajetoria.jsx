...
class Trajetoria extends React.Component {
    render() {
        return (
            <div class="afoot lg-12 md-12 sm-12">


                <img src="https://i.imgur.com/Dce34lP.png" alt="trajetoria_link" class="row lg-12 md-12 sm-12" />
                <form action="contact" class="row lg-12 md-12 sm-12">
                    ...
                    <h1 class="lg-12 md-12 sm-12"> trajetoria </h1>
                </form>
